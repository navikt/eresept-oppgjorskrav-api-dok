...
| [Send inn oppgjørskrav (JSON)](oppgjorskrav.md)                            | /oppgjorskrav/oppgjorskrav       | hdir:eresept-ok/oppgjorskrav | hdir:eresept-ok  | POST/JWE   | Innsending av oppgjørskrav                                               |
...
| [Hent takster](takst.md)                                                   | /takst/takster                   | hdir:eresept-ok/takst        | hdir:eresept-ok  | GET/JSON   | Returnerer takster, kun for apotek.                                      |
